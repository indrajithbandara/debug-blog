...
Toda informacao de autenticaco e autorizacao de usuarios fica na colecao system.users no banco de dados admin.Toda

para gerenciar essa colecao o MongoDB nos prove os comandos de gerenciamento de usuarios.para

...
##### Exercicio
1 - Trocar para a database platinas
$ use platinas

2 - Listagem de todos os Pokemons com a altura menor que 0.5 (passo 2)

#### Primeiro ciamos nossa query de busca com todos abaixo ou igual a 16
$ var query = { pwd: {$lte: 16}}

##### Digitamos para conferir a query e vegos que ele pegou o 16
$ query
{ "pwd": {"$lte": 16 }
 }

##### E finalmente fazemos a busca 
 db.platinas.find(query)
{
  "_id": ObjectId("5887c14dc3c140bf01b05339"),
  "name": "Wolfenstein: The Old Blood",
  "pwd": 16,
}
{
  "_id": ObjectId("5887dea5c3c140bf01b0533a"),
  "name": "payday 2",
  "pwd": 2,
}

3 - Listagem de todos os Pokemons com a altura maior ou igual que 0.5 (passo 3)

4 - Listagem de todos os Pokemons com a altura menor ou igual que 0.5 E do tipo grama (passo 4)
5 - Listagem de todos os Pokemons com o nome Pikachu ou com attack menor ou igual que 0.5 (passo 5)
6 - Listagem de todos os Pokemons com o attack maior ou igual que 48 E com height menor ou igual que 0.5 (passo 6)

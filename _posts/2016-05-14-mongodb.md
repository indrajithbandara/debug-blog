...
mongoimport --host 127.0.0.1 --db be-mean --collection pokemons.json --drop --file pokemons.json 
...
### Pegamos nosso primeiro pokemon com 35 de defesa usando limite
...
## nosso segundo pokemon tem 43  
db.pokemons.find().limit(2)
{
  "defense": 43,

}
## Podemos usar o skip, e o terceiro pokemons tem 58
db.pokemons.find().limit(1).skip(2)
{
  "hp": 58,
}

...
var query = {"_id": ObjectId("5716d2c1cd4f60b059760d77")}
...
O operador $pullAll retira cada valor do [Array_de_valores], caso o campo seja um 
*Array* existente. Caso não exista ele não fará nada.
...
### Passamos o valor a retirar
var attacks = ['choque do trovão']

#### Passando o array de attacks no noso modificador
var mod = {$pullAll: {moves: attacks}}

#### Só execultar o update.
db.pokemons.update(query, mod)

#### No find já não existe mais o campo
db.pokemons.find(query)
